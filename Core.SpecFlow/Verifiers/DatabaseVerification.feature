...
Scenario: For an existing database check the result string
	...
	Then the first result message on the screen should be Success connecting to Nirvana, connection string : Data Source=.\CDR;Initial Catalog=nirvana_small;Integrated Security=SSPI
...
Scenario: For a non existent database check the result string
	...
	Then the first result message on the screen should be Failure connecting to NirvanaNotExists, connection string : Data Source=.\CDR;Initial Catalog=nirvana_notExists;Integrated Security=SSPI
