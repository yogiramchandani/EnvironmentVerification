...
Scenario: For an existing directory, check the result message
	...
	Then the directory verification result message should be Success connecting to Templates, path: D:\AppShare\DataSuite\Templates
...
Scenario: For a non existent directory, check the result message
	...
	Then the directory verification result message should be Failure connecting to Invalid, path: D:\AppShare\DataSuite\Invalid
