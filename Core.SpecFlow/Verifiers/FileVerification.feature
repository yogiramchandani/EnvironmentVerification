...
Scenario: For an existing File, check the result message
	...
	Then the File verification result message should be Success connecting to Templates, file path: D:\AppShare\DataSuite\Templates\UtilFunctions.xslt
...
Scenario: For a non existent File, check the result message
	...
	Then the File verification result message should be Failure connecting to Invalid, file path: D:\AppShare\DataSuite\Invalid\UtilFunctions.xslt
